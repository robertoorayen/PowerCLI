...
##TODO Gestión de errores
        ...
        foreach ($vCenter in $vCenters) {
            #####vCenter Connection 
            $vcenter_connection += Connect-VIServer -Server $vCenter.vCenter -User $vCenter.Username -Pass $vCenter.Password
